...
namespace ControlCatalog.Pages
{
    public partial class DataGridPage : ContentPage
    {
        public DataGridPage()
        {
            ...
            var list = new ObservableCollection<Person> { new Person { FirstName = "John", LastName = "Doe", Age = 30 }, new Person { FirstName = "Elizabeth", LastName = "Thomas", IsBanned = true, Age = 40 }, new Person { FirstName = "Zack", LastName = "Ward", Age = 50 } };
